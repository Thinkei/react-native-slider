...
var maximumDraggableValue=_this.props.maximumDraggableValue;

if(value<=maximumDraggableValue){
_this.state.value.setValue(value);
}else{
_this.state.value.setValue(maximumDraggableValue);
}
},_this.
...
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:566}}));
...
var fixMaximumValueUpdate=function fixMaximumValueUpdate(Component){return function(_PureComponent2){_inherits(FixMaximumValueUpdateSlider,_PureComponent2);function FixMaximumValueUpdateSlider(){var _ref2;var _temp2,_this2,_ret2;_classCallCheck(this,FixMaximumValueUpdateSlider);for(var _len2=arguments.length,args=Array(_len2),_key2=0;_key2<_len2;_key2++){args[_key2]=arguments[_key2];}return _ret2=(_temp2=(_this2=_possibleConstructorReturn(this,(_ref2=FixMaximumValueUpdateSlider.__proto__||Object.getPrototypeOf(FixMaximumValueUpdateSlider)).call.apply(_ref2,[this].concat(args))),_this2),_this2.

state={
value:_this2.props.value,
maximumValue:_this2.props.maximumValue},_temp2),_possibleConstructorReturn(_this2,_ret2);}_createClass(FixMaximumValueUpdateSlider,[{key:'render',value:function render()


{
return _react2.default.createElement(Component,_extends({},this.props,{maximumValue:this.state.maximumValue,value:this.state.value,__source:{fileName:_jsxFileName,lineNumber:621}}));
}},{key:'_updateStateValue',value:function _updateStateValue(
...
prevProps,prevState){var _this3=this;
if(this.props.maximumValue!==prevState.maximumValue){

this.setState({maximumValue:this.props.maximumValue},function(){
_this3._updateStateValue(prevState);
});
}else{
this._updateStateValue(prevState);
}
}}]);return FixMaximumValueUpdateSlider;}(_react.PureComponent);};exports.default=


fixMaximumValueUpdate(Slider);